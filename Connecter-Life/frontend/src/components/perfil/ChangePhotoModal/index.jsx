...
const ChangePhotoModal = () => {
  const { profileImage, uploadProgress, isEditMode, setSelectedPublication } =
    useMyContext(); // Adiciona setSelectedPublication aqui
  ...
  // Função para limpar o estado selectedPublication
  const clearSelectedPublication = () => {
            ...
            <div className="modal-buttons">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  clearSelectedPublication(); // Chama a função para limpar o estado selectedPublication
                }}
              >
                Voltar
              </button>
