...
function LoginForm() {
    ...
    const [registrationFormPassword, setRegistrationFormPassword] =
        useState("");
    ...
    const toggleConfirmPasswordVisibility = () => {
        ...
        setConfirmPasswordInputType(showConfirmPassword ? "password" : "text"); // Definir o tipo de entrada com base no estado atualizado de showConfirmPassword
    };
    ...
    const handleRegisterButtonClick = async () => {
        ...
        errors.firstName =
            formFields.firstName.length < 3
                ? t("first_name_length_error")
                : null;
        errors.lastName =
        ...
        const passwordRegex =
            /^(?=.*[a-zA-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/;
        errors.password = !passwordRegex.test(registrationFormPassword)
        ...
        errors.confirmPassword =
            registrationFormPassword !== formFields.confirmPassword
                ...
                : null;
        errors.phone =
            formFields.phone.length < 3 ? t("phone_length_error") : null;
    ...
    const checkFieldAvailability = async (fieldName, value, t) => {
        try {
            const response = await axios.post(
                `http://localhost:3000/auth/checkAvailability`,
                {
                    fieldName,
                    value
                }
            ...
            console.error(
                t(`Error checking availability of ${fieldName}:`),
                error
            );
