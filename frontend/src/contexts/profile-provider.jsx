...
const MyContextProvider = ({ children }) => {
    ...
    return <MyContext.Provider value={{
      ...
      selectedPublicationModalOpen, setSelectedPublicationModalOpen,
      selectedPhotoPosition, setSelectedPhotoPosition,
      uploadInProgress, setUploadInProgress,
      userDataLoaded, setUserDataLoaded,
      currentImageIndex, setCurrentImageIndex,
      numberOfFollowers, setNumberOfFollowers,
      numberOfFollowing, setNumberOfFollowing,
