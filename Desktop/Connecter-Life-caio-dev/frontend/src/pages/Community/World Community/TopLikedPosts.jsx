...
const TopLikedPosts = ({ topLikedPosts, t }) => {
  ...
  const handleNext = () => {
    if (carouselRef.current) {
      const maxIndex = Math.floor(carouselRef.current.scrollWidth / carouselRef.current.clientWidth) - 1;
      setCarouselIndex((prevIndex) => (prevIndex < maxIndex ? prevIndex + 1 : prevIndex));
    }
  };
