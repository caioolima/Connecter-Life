...
const ResetPassword = ({ onClose }) => {
  ...
  const resetPassword = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/auth/requestPasswordReset",
        {
          method: "POST",
          headers: {
  ...
  const verifyCode = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3000/auth/verifyCode`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:3000/auth/resetPassword/${code.join("")}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
