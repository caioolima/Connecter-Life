...
const CreateCommunityModal = () => {
    ...
    const { isCreateCommunityModalOpen, setIsCreateCommunityModalOpen } = useMyContext();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("http://localhost:3000/communities/comunidade/criar/" + nome, {
                method: "POST",
                headers: {
        ...
        <div className={styles.modalOverlayCreate}>
            <div className={styles.modalContentCreate}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label>
                        {t("community_image")}
                        <input type="file" onChange={handleImagemChange} accept="image/*" className={styles.fileInput} />
                    </label>
                    <div className={styles.modalButtonsCreate}>
                        <button type="button" onClick={handleCloseModal}>{t("cancel")}</button>
