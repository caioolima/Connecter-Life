...
exports.likeGalleryImage = async (req, res) => {
  try {
    ...
    if (image.likes.includes(likerId)) {
      return res
        .status(400)
        .json({ success: false, message: "Você já curtiu esta imagem." });
    }
    ...
    return res
      ...
      .json({
        success: false,
        message: "Erro interno do servidor ao curtir a imagem.",
      });
  }
};
  ...
  try {
    ...
    if (likerIndex === -1) {
      return res
        ...
        .json({
          success: false,
          message: "Você ainda não curtiu esta imagem.",
        });
    }
    ...
    return res
      .status(200)
      .json({ success: true, message: "Like removido com sucesso da imagem." });
  } catch (error) {
    ...
    return res
      ...
      .json({
        success: false,
        message: "Erro interno do servidor ao remover o like da imagem.",
      });
  }
};
...
exports.getLikes = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        success: false,
        message: "Erro interno do servidor ao obter as curtidas da imagem.",
      });
  }
};
